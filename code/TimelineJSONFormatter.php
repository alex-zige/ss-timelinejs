...
/**
 * Overwrite the existing Timeline JSONFormatter convertDataObjectSet method 
 *
 * @package ss_timelinejs
 * @author alex
 **/

class TimelineJSONFormatter extends JSONDataFormatter{


	/**
	 * Custom the JSON output for Timeline output
	 * Original : Generate a JSON representation of the given {@link SS_List}.
	 * 
	 * @param SS_List $set
	 * @return String XML
	 */
	public function convertDataObjectSet(SS_List $set, $fields = null) {
		...
		// define the customised output for timeline output.
